...
const CustomSlider = () => {
  ...
  useEffect(() => {
    // Fetching slider data on component mount (replacing UNSAFE_componentWillMount)
  ...
  // Settings for the slider including autoplay
  const settings = {
    dots: true,
    infinite: true,
    speed: 600,
    ...
    autoplaySpeed: 3500, // Time between slides (in ms)
    responsive: [
